...
/**
 * Controlador para la vista de gestión de retos.
 */
public class ManageChallengesController implements Initializable {
    ...
    @FXML
    private Button editChallengeButton;

    @FXML
    private Button deleteChallengeButton;
     ...
     * Constructor.
     */
    public ManageChallengesController() {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        challengesTable.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            ...
            editChallengeButton.setDisable(disableButtons);
            deleteChallengeButton.setDisable(disableButtons);
        });
    }
    ...
    private void handleCreateChallengeButton(ActionEvent event) {
        if (mainController != null) {
            mainController.loadCreateChallengeView();
        }
    }

    /**
     * Maneja el botón para editar retos.
     *
     * @param event El evento de acción
     */
    @FXML
    private void handleEditChallengeButton(ActionEvent event) {
        ...
        if (selectedChallenge != null && mainController != null) {
            try {
    ...
    /**
     * Maneja el botón para eliminar retos.
     *
     * @param event El evento de acción
     */
    @FXML
    private void handleDeleteChallengeButton(ActionEvent event) {
        Challenge selectedChallenge = challengesTable.getSelectionModel().getSelectedItem();
